...
Red Marker -> location of each passenger
Blue Marker -> location of bus stop

Straight Line connecting each passenger to closest bus stop

Pop Up over bus stop:
- number of passengers closest to that stop